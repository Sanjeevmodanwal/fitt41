...
@Component({
  selector: 'app-bg-img',
  templateUrl: './bg-img.page.html',
  styleUrls: ['./bg-img.page.scss'],
})
export class BgImgPage implements OnInit {
  ...
  ngOnInit() {
    // this.num = this.activatedRoute.snapshot.paramMap.get('id');
  ...
  uploadImage() {
    ...
    fileTransfer.upload(this.croppedImagepath, 'https://www.mag-studios.com/Fitt41/Api/upbg', options)
      .then((data) => {
        console.log(data);
